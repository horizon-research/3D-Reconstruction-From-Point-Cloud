...
[1. Reconstruct Mesh from Point Cloud](#1-reconstruct-mesh-from-point-cloud)

[2. Color Transfer](#2-color-transfer)

[3. Prepare for use in Unity using Blender](#3-prepare-for-use-in-unity-using-blender-open-source-last-updated-for-v279b-using-defualt-layout)

[4. Import to Unity](#4-import-to-unity-free-personal-use-last-updated-for-v201841f1)
